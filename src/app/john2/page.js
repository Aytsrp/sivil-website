...
const Profile = () => {
  return (
    <motion.div className="flex flex-col md:flex-row px-8 py-12 gap-4" initial={{ y: 20, opacity: 0 }}
      animate={{ y: 0, opacity: 1 }}
      transition={{ ease: "easeInOut", duration: 0.5 }}>
        <Image src={Orange} alt="picture" width={500} className="object-cover"/>
        <div className="flex flex-col gap-4">
          <p className="text-2xl font-bold">John Doe II</p>
