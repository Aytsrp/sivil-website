  ...
  return (
    <motion.div className="flex flex-col lg:flex-row px-8 py-8 gap-4 items-center md:items-start" initial={{ y: 20, opacity: 0 }}
      ...
      transition={{ ease: "easeInOut", duration: 0.5 }}>
        <Image src={Pp} alt="picture" width={500} className="object-cover"/>
        <div className="flex flex-col gap-4">
          <p className="text-2xl font-bold">PT PP (Persero) Tbk</p>
          <div className="flex flex-col text-sm gap-2 text-justify">
            <p>
              Dikenal sebagai salah satu raksasa di bidang konstruksi dengan aset besar. Mereka menangani proyek infrastruktur, gedung bertingkat, dan properti. Rating 4,6/5
            </p>
          </div>
